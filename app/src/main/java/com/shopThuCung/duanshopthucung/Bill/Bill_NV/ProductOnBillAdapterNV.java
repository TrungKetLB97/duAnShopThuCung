...
public class ProductOnBillAdapterNV extends RecyclerView.Adapter<ProductOnBillAdapterNV.ViewHolder> {
    List<Product> productList;
    ProductDAO productDAO;

    public ProductOnBillAdapterNV(List<Product> productList) {
    ...
    @NonNull
    @Override
    public ProductOnBillAdapterNV.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_san_pham_nv, parent, false);
        productDAO = new ProductDAO(parent.getContext());
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ProductOnBillAdapterNV.ViewHolder holder, int position) {
