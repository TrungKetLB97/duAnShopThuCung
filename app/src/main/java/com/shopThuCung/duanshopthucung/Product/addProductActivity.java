...
private ProductDAO dao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_Product_edtCode = findViewById(R.id.add_Product_edtCode);
        add_Product_edtName = findViewById(R.id.add_Product_edtName);
        add_Product_edtTuoi = findViewById(R.id.add_Product_edtTuoi);
        add_Product_edtCanNang = findViewById(R.id.add_Product_edtCanNang);
        add_Product_edtGioiTinh = findViewById(R.id.add_Product_edtGioiTinh);
        add_Product_edtSucKhoe = findViewById(R.id.add_Product_edtSucKhoe);
        add_Product_edtGiatien = findViewById(R.id.add_Product_edtGia);
    }
    ...
    public void postProduct(View view) {
